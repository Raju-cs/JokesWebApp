...
namespace JokesWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> ShowSearchResult(string SearchPharse)
        {
            return View("Index", await _context.Joke.Where(j => j.JokeQuestion.Contains(SearchPharse)).ToListAsync()); ;
